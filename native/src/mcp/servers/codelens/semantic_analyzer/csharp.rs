...
pub fn builtins() -> HashSet<&'static str> {
    [
        ...
        "string", "object", "dynamic", "void", "var",
        // keywords
        "this", "base", "null", "true", "false", "value",
        // System
        "Console", "Math", "Convert", "Environment", "GC", "AppDomain",
        ...
        "OverflowException", "InvalidCastException", "FormatException",
        "ObjectDisposedException", "OutOfMemoryException", "StackOverflowException",
        "Type", "Activator", "Attribute", "IDisposable", "IComparable",
        "IEquatable", "IEnumerable", "IEnumerator", "ICloneable",
        "IFormattable", "IServiceProvider", "EventHandler", "EventArgs",
        "Action", "Func", "Predicate", "Comparison", "Converter",
        "Nullable", "Tuple", "ValueTuple", "Guid", "DateTime", "DateTimeOffset",
        "TimeSpan", "Random", "Version", "Uri", "Lazy",
        // collections
        "List", "Dictionary", "HashSet", "SortedSet", "SortedDictionary",
        "SortedList", "Queue", "Stack", "LinkedList", "ArrayList",
        "Hashtable", "BitArray", "Collection", "ReadOnlyCollection",
        "ObservableCollection", "IList", "ICollection", "IEnumerable",
        "IDictionary", "ISet", "IReadOnlyList", "IReadOnlyCollection",
        "IReadOnlyDictionary", "KeyValuePair",
        // LINQ
        "Enumerable", "Queryable", "IGrouping", "ILookup", "IOrderedEnumerable",
        // Task / async
        "Task", "ValueTask", "CancellationToken", "CancellationTokenSource",
        "ConfigureAwait",
        // attributes
        "Serializable", "Obsolete", "Flags", "DllImport", "MarshalAs",
        "StructLayout", "ThreadStatic", "Conditional", "DebuggerDisplay",
    ]
    .into_iter()
    .collect()
}
