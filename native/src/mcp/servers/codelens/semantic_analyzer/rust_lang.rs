...
pub fn builtins() -> HashSet<&'static str> {
    [
        ...
        "RwLock", "Option", "Result", "Ok", "Err", "Some", "None",
        "HashMap", "HashSet", "BTreeMap", "BTreeSet", "VecDeque",
        "LinkedList", "BinaryHeap", "PhantomData", "Cow", "Pin",
        // traits
        "Copy", "Clone", "Debug", "Default", "Drop", "Eq", "Hash",
        "Ord", "PartialEq", "PartialOrd", "Send", "Sync", "Sized",
        "Unpin", "Fn", "FnMut", "FnOnce", "Iterator", "IntoIterator",
        "From", "Into", "TryFrom", "TryInto", "AsRef", "AsMut", "Deref",
        "DerefMut", "Borrow", "BorrowMut", "ToOwned", "ToString",
        "Display", "Write", "Read", "Seek", "BufRead", "Error",
        "Future", "Stream", "Extend", "FromIterator", "DoubleEndedIterator",
        "ExactSizeIterator", "FusedIterator", "Index", "IndexMut",
        "RangeBounds", "Step",
        // macros
        "println", "eprintln", "print", "eprint", "format", "write",
        "writeln", "vec", "assert", "assert_eq", "assert_ne", "debug_assert",
        "debug_assert_eq", "debug_assert_ne", "panic", "todo", "unimplemented",
        "unreachable", "cfg", "include", "include_str", "include_bytes",
        "env", "option_env", "compile_error", "concat", "stringify",
        "line", "column", "file", "module_path", "matches", "const_format",
        // keywords that look like identifiers
        "self", "Self", "super", "crate",
        // common std items
        "std", "core", "alloc", "main",
        "Box", "ToOwned", "Clone", "Clone",
        // common derive helpers
        "Serialize", "Deserialize",
        // common crate names (may appear as bare idents in macros)
        "napi", "serde", "serde_json", "rusqlite", "tokio", "blake3",
        "reqwest", "uuid", "chrono", "regex", "log", "anyhow", "thiserror",
        "tracing", "futures", "async_trait",
        // common napi / serde types
        "Status", "Value", "Number", "Map", "Array", "Boolean",
        "Undefined", "Null", "Object", "Function", "Promise",
        "Env", "CallbackInfo", "JsUndefined", "JsNull", "JsBoolean",
        "JsNumber", "JsString", "JsObject", "JsArray", "JsFunction",
        "JsUnknown", "JsError", "Either", "Task", "AsyncTask",
        "Connection", "OptionalExtension", "Params", "Statement",
        // common attribute / derive names
        "derive", "cfg", "allow", "warn", "deny", "forbid",
        "deprecated", "must_use", "repr", "inline", "test",
        "non_exhaustive", "cold", "target_feature",
        // common trait method names that may appear as bare idents
        "new", "default", "from", "into", "try_from", "try_into",
        "as_ref", "as_mut", "to_string", "to_owned", "clone", "fmt",
        "hash", "eq", "cmp", "next", "len", "is_empty", "iter",
        "push", "pop", "insert", "remove", "contains", "get",
        "unwrap", "expect", "map", "and_then", "or_else",
        "ok_or", "ok_or_else", "unwrap_or", "unwrap_or_else",
        "is_some", "is_none", "is_ok", "is_err", "collect",
        "filter", "find", "any", "all", "count", "fold",
        "enumerate", "zip", "chain", "take", "skip", "rev",
        "sort", "sort_by", "split", "join", "replace", "trim",
        "parse", "format", "write", "read", "flush", "seek",
        "spawn", "spawn_blocking", "block_on", "await",
        "run", "execute", "query", "query_row", "prepare",
        "open", "create", "close", "send", "recv", "poll",
        "encode", "decode", "serialize", "deserialize",
        "to_hex", "as_bytes", "as_str", "to_vec", "to_owned",
        "starts_with", "ends_with", "chars", "bytes", "lines",
        "strip_prefix", "strip_suffix", "repeat", "fill",
        "extend", "retain", "dedup", "reverse", "truncate",
        "resize", "swap", "clear", "drain", "position",
        "binary_search", "windows", "chunks", "flat_map",
        "for_each", "inspect", "peekable", "cycle",
        "min", "max", "sum", "product", "nth", "last",
        "copied", "cloned", "flatten", "unzip",
    ]
    .into_iter()
    .collect()
}
