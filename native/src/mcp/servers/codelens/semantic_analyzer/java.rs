...
pub fn builtins() -> HashSet<&'static str> {
    [
        ...
        "Thread", "Runnable", "Exception", "Error", "Throwable",
        ...
        "FunctionalInterface", "SafeVarargs", "Class", "ClassLoader",
        "Process", "ProcessBuilder", "Package", "Enum", "Record",
        "Void", "StrictMath", "Compiler", "InheritableThreadLocal",
        "ThreadLocal", "ThreadGroup", "SecurityManager",
        // common java.util
        "List", "ArrayList", "LinkedList", "Map", "HashMap", "TreeMap",
        "LinkedHashMap", "Set", "HashSet", "TreeSet", "LinkedHashSet",
        "Queue", "Deque", "ArrayDeque", "PriorityQueue", "Collection",
        "Collections", "Arrays", "Iterator", "Optional", "Stream",
        "Comparator", "Date", "Calendar", "UUID", "Objects",
        // common java.io
