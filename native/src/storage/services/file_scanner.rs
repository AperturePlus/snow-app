...
pub const TEXT_EXTENSIONS: &[&str] = &[
    ...
    "rs", "go", "ts", "tsx", "js", "jsx", "mjs", "cjs", "py", "java", "kt",
    "swift", "rb", "php", "c", "h", "cpp", "cc", "cxx", "hpp", "hxx", "cs",
    "fs", "fsx", "scala", "clj", "cljs", "edn", "ex", "exs", "erl", "hrl",
    "hs", "lhs", "ml", "mli", "nim", "cr", "d", "dart", "elm", "gleam",
    "groovy", "gradle", "jl", "lua", "pl", "pm", "r", "rb", "scm", "rkt",
    "v", "zig", "vala", "pas", "pp", "asm", "s", "S",
    // Web
    "html", "htm", "css", "scss", "sass", "less", "styl", "vue", "svelte",
    "astro", "php", "ejs", "hbs", "handlebars", "pug", "jade", "twig",
    // Config & data
    "json", "json5", "jsonc", "yaml", "yml", "toml", "ini", "cfg", "conf",
    "properties", "env", "xml", "svg", "plist", "editorconfig",
    // Docs & markup
    "md", "markdown", "mdx", "rst", "txt", "tex", "org", "adoc", "asciidoc",
    // Shell & scripts
    "sh", "bash", "zsh", "fish", "ps1", "psm1", "bat", "cmd", "vbs", "ahk",
    // Build & project files
    "cmake", "mk", "makefile", "dockerfile", "containerfile", "gemspec",
    "rakefile", "brewfile", "procfile", "nix",
    // SQL
    "sql", "psql", "mysql",
    // Other
    "gitignore", "dockerignore", "npmignore", "editorconfig", "eslintrc",
