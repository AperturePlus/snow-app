export const en = {
  ...
  "sidebar.chatMultiSelectDeleteConfirm": "Delete {{count}} selected conversations?",
  ...
  "settings.imagegenDescription": "Configure OpenAI and Gemini channels independently; both can be enabled at the same time and the agent picks one per request. When no channel is configured, the image generation tool is hidden from the agent.",
  "settings.closeImagegenSettings": "Close image generation settings",
  "settings.imagegenChannels": "Channels",
  "settings.imagegenChannelOpenai": "OpenAI-compatible channel (gpt-image)",
  ...
  "settings.imagegenProviderOpenai": "OpenAI-compatible",
  ...
  "settings.imagegenModelHint": "Required: the agent has no built-in default model",
  "settings.imagegenModelsLoadError": "Failed to load image models",
  "settings.imagegenModelsLoading": "Loading image models...",
  "settings.imagegenModelsEmpty": "No image models found. Check the base URL and API key, or enter the model ID manually.",
  ...
  "settings.imagegenDefaultSizeHint": "Gemini: aspect ratio (16:9) or image size (1K/2K/4K). OpenAI: e.g. 1024x1024",
  ...
  "settings.imagegenWebSearchHint": "Gemini only: let Imagen use real-time web information",
  "settings.imagegenStreaming": "Streaming preview",
  "settings.imagegenStreamingHint": "Streaming: show intermediate preview images while generating; Non-streaming: show images once generation finishes (OpenAI gpt-image / Gemini Imagen)",
  ...
  "settings.imagegenNavHint": "Channels are independent; enable one or both as you like.",
  "settings.imagegenNavNone": "With no channel enabled, the image generation tool is hidden from the agent.",
  ...
  "settings.imagegenNoChannels": "No channels yet. Click \"Add channel\" to create one.",
  ...
  "settings.imagegenChannelNameHint": "Custom name shown in the list and used by the agent (leave empty to use the default).",
  ...
  "settings.imagegenToggleMissingModel": "Configure an API key and a model for this channel before enabling it — the image generation tool only becomes available when a channel has both.",
  "settings.imagegenEditorInfo": "Each channel is fully independent: provider, base URL, API key, model and defaults.",
  ...
  "settings.imagegenSizeArbitraryHint": "This model also accepts any WxH (divisible by 16, aspect 1:3–3:1, up to 3840x2160; above 2560x1440 is experimental).",
  "settings.imagegenModelPreviewBadge": "Preview",
  "settings.imagegenSizeLimitsHint": "Rules: max side ≤3840px AND total pixels 655,360–8,294,400 (multiples of 16, aspect ≤3:1). Largest square is 2880x2880; 16:9 tops at 3840x2160; the 4K tier is the recommended size closest to the pixel cap for each ratio.",
  "settings.imagegenMaxConcurrent": "Max concurrent generations",
  "settings.imagegenMaxConcurrentHint": "When the agent requests several images at once, at most this many are generated in parallel (1-8); the rest wait in the queue, and a new one starts as soon as one finishes. Lower it if your provider rate-limits image requests.",
  "settings.imagegenMaxConcurrentDecrease": "Decrease max concurrent generations",
  "settings.imagegenMaxConcurrentIncrease": "Increase max concurrent generations",
