export const en = {
  ...
  "settings.imagegenDescription": "Independent image generation configuration, separate from the conversation API. No built-in default model: the agent uses this model unless it passes the model argument explicitly.",
