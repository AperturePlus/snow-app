export const en = {
  ...
  "toolCall.bash.arguments": "Arguments",
  "toolCall.bash.command": "Command",
  "toolCall.bash.timeout": "Timeout",
  "toolCall.bash.interactive": "Interactive",
  "toolCall.bash.boolean.yes": "Yes",
  "toolCall.bash.boolean.no": "No",
  ...
  "toolCall.bash.noResult": "Command completed without a returned result",
  ...
  "topBar.todo.selectAll": "Select all",
  "topBar.todo.selectTodo": "Select TODO",
  "topBar.todo.selectedCount": "{{count}} selected",
  ...
  "settings.subAgentKicker": "Rust persisted",
  ...
  "settings.hooksKicker": "Snow CLI compatible",
  ...
  "settings.terminalKicker": "Terminal",
  ...
  "settings.privacyKicker": "Privacy",
